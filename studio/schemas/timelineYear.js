export default {
  ...
  fields: [
    ...
    },
    {
      ...
      fields: [
        {name: 'games', title: 'Games Played', type: 'string'},
        {name: 'gamesPlayed', title: 'Games Played (alt)', type: 'number'},
        {name: 'ppg', title: 'Points Per Game', type: 'string'},
        {name: 'rpg', title: 'Rebounds Per Game', type: 'string'},
        {name: 'apg', title: 'Assists Per Game', type: 'string'},
        {name: 'spg', title: 'Steals Per Game', type: 'string'},
        {name: 'bpg', title: 'Blocks Per Game', type: 'string'},
      ],
    },
    {
      name: 'gallery',
